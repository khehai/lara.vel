  ...
  <div class="flex md:flex-row -mx-4">
      ...
      <div x-data="{ image: 1 }" x-cloak>
        ...
        <div class="h-64 md:h-80 rounded-lg mb-4">
          ...
          <div x-show="image === 1" class="h-64 md:h-80 rounded-lg bg-gray-100 mb-4 flex items-center justify-center">
            <span class="text-5xl"><img src="{{ asset('/storage/'.$pictures[0]['url']) }}" class="object-cover h-32 mt-2 w-60 text-center"></span>
          </div>

          <div x-show="image === 2" class="h-64 md:h-80 rounded-lg bg-gray-100 mb-4 flex items-center justify-center">
            <span class="text-5xl"><img src="{{ asset('/storage/'.$pictures[1]['url']) }}" class="object-cover h-32 mt-2 w-60 text-center"></span>
          </div>

          <div x-show="image === 3" class="h-64 md:h-80 rounded-lg bg-gray-100 mb-4 flex items-center justify-center">
            <span class="text-5xl"><img src="{{ asset('/storage/'.$pictures[2]['url']) }}" class="object-cover h-32 mt-2 w-60 text-center"></span>
          </div>

          <div x-show="image === 4" class="h-64 md:h-80 rounded-lg bg-gray-100 mb-4 flex items-center justify-center">
            <span class="text-5xl"><img src="{{ asset('/storage/'.$pictures[3]['url']) }}" class="object-cover h-32 mt-2 w-60 text-center"></span>
          </div>
        ...
        <div class="flex -mx-2 mb-4">
            <template x-for="i in 4">
              <div class="flex-1 px-2">
                <button x-on:click="image = i" :class="{ 'ring-offset-2 ring-2 ring-indigo-500': image === i }" class="focus:outline-none w-full rounded-lg h-24 md:h-32 bg-white flex items-center justify-center">
    ...
    <div class="w-full md:w-1/2 px-4">
        ...
        <div class="flex py-4 space-x-4">
          ...
          <button type="button" class="h-14 px-6 py-2 font-semibold rounded-lg bg-indigo-600 hover:bg-indigo-500 text-white">
            Add to Cart
          </button>
