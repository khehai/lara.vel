<div class="flex space-x-1 justify-around">
    ...
    <a href="{{ route('admin.products.show', [$slug]) }}" class="p-1 text-teal-600 hover:bg-teal-600 hover:text-white rounded">
